...
urlpatterns = [
	url(r'^esper/hierarchy/(?P<hierarchy_id>(\d){1,32})$',
	    GetEventTypesByHierarchyId.as_view(), name="get-event-types-by-hierarchy-id"),
	url(r'^esper/(?P<event_type_id>(\d){1,32})$',
	    GetEventTypeById.as_view(), name="get-event-type-by-id"),
]
